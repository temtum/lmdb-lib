declare module "lmdb-lib" {
  ...
  class Cursor<T extends Key> {
    constructor(txn: Txn, dbi: Dbi, keyType?: KeyType);

    goToFirst(options?: KeyType): Buffer | null;
    goToLast(options?: KeyType): Buffer | null;
    goToNext(options?: KeyType): Buffer | null;
    goToPrev(options?: KeyType): Buffer | null;
    goToKey(key: T, options?: KeyType): Buffer | null;
    goToRange(key: T, options?: KeyType): Buffer | null;

    goToFirstDup(options?: KeyType): Buffer | null;
    goToLastDup(options?: KeyType): Buffer | null;
    goToNextDup(options?: KeyType): Buffer | null;
    goToPrevDup(options?: KeyType): Buffer | null;
    goToDup(key: T, data: Value, options?: KeyType): Buffer | null;
    goToDupRange(key: T, data: Value, options?: KeyType): Buffer | null;
